...
(def skills
    ...
    (make-skill "Magic"                 800 4 1
		[
			...
			(make-skill "Reveal abilities of another mage" 	805 2)
			(make-skill "Tap health for aura" 				806 3)
			(make-skill "Heal" 								807 3)
			(make-skill "Modern magic script" 				808 3)
    ...
    (make-skill "Gatecraft"             860 5 1
		[
			...
			(make-skill "Detect gates" 					862 2)
			(make-skill "Jump through gate" 			863 2)
