...
(deftest should-make-GateHits
    ...
    (are [exp-hits detections]
         ...
         [(analyze.GateHits. "ab23" #{ "ab24" }) (analyze.GateHits. "ab25" #{ "ab24" }) 
          (analyze.GateHits. "aa24" #{ "ab24" }) (analyze.GateHits. "ac24" #{ "ab24" })]
         [(make-gate-distance "ab24" 1)]
         
         [(analyze.GateHits. "ab23" #{ "ab24" }) (analyze.GateHits. "ab25" #{ "ab24" "ab26" }) 
          (analyze.GateHits. "aa24" #{ "ab24" }) (analyze.GateHits. "ac24" #{ "ab24" })
          (analyze.GateHits. "aa26" #{ "ab26" }) (analyze.GateHits. "ac26" #{ "ab26" })
          (analyze.GateHits. "ab27" #{ "ab26" })]
