...
(def skills
    ...
    (make-skill "Religion"              750 5 1 
		[
			...
			(make-skill "Lay to rest" 			        752 4)
			(make-skill "Preparatory ritual" 			753 3)
			(make-skill "Resurrect dead noble"			754 4)
    ...
    (make-skill "Scrying"               840 5 1 
		[
			...
			(make-skill "Ciphered writing of Areth-Pirn" 		842 3)
			(make-skill "Shroud location from magical scry" 	843 2)
			(make-skill "Dispel location shroud" 				844 3)
    ...
    (make-skill "Artifact construction" 880 6 1
		[
			...
			(make-skill "Arcane symbols" 					882 3)
			(make-skill "Forge magical weapon" 				883 3)
			(make-skill "Forge magical armor" 				884 3)
			(make-skill "Forge magical bow" 				885 3)
			(make-skill "Curse noncreator loyalty" 			886 2)
			(make-skill "Reveal creator of artifact" 		887 2)
			(make-skill "Reveal where artifact was created" 888 2)
			(make-skill "Destroy artifact" 					889 3)
			(make-skill "Cloak creator of artifact" 		891 4)
			(make-skill "Cloak region of artifact creation" 892 2)
			(make-skill "Dispel cloaking from artifact" 	893 3)
			(make-skill "Forge palantir" 					894 3)
		]) 
    (make-skill "Necromancy"            900 6 2 
		[
			(make-skill "Raise undead" 					901 3)
			(make-skill "Summon ghost warriors" 		902 3)
			(make-skill "Runes of Evil" 				903 3)
			(make-skill "Summon demon lord" 			904 3)
			(make-skill "Renew demon bond" 				905 3)
			(make-skill "Banish demon lord" 			906 3)
			(make-skill "Eating of the dead" 			907 4)
			(make-skill "Aura blast" 					908 3)
			(make-skill "Absorb aura blast" 			909 3)
			(make-skill "Transcend death" 				911 4 1 nil)
		])
